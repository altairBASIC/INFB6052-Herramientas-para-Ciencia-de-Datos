...
- [X] `README.md` completo, sin TODO pendientes.
- [X] Entorno reproducible (`requirements.txt`).
- [X] Notebook(s) ejecutados de inicio a fin sin errores (celdas en orden).
- [X] Scripts funcionan con rutas relativas del repo.
- [X] Métricas y modelo guardados en `artifacts/`.
- [X] Reporte final claro y conciso.
- [X] Commits limpios y en orden lógico.
- [X] No hay credenciales / datos sensibles.
...
Revisa que la versión final del repositorio represente un flujo claro y replicable de tu trabajo. La documentación es parte integral de la evaluación.

---

Si necesitas que incorpore directamente el detalle exacto de los criterios o porcentajes desde el PDF, indícame el contenido o pega el texto relevante y lo incorporo.
